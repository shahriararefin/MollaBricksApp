...
def index():
    ...
    # We will get categories from the expense_categories table for the dropdown
    ...
    if code:
        where_clauses.append("product_code LIKE ?")
...
def add_type():
    ...
    try:
        query = """
            INSERT INTO brick_types (name, product_code, category, unit, status, made_by) 
            VALUES (?, ?, ?, ?, ?, ?)
        """
